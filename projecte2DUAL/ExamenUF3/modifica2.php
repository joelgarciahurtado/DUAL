...
$consulta = "SELECT * FROM country WHERE Region='$regio'";
...
?>
                ...
                <form method="POST" action="modifica3.php" name="modificaform">
                <p>Escriu el nom del país que vols modificar</p>
